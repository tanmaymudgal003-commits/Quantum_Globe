...
# ═══════════════════════════════════════════════════════════════════════════════
CITIES = [
    {"id":"noida_sec62",  "name":"Noida",     "country":"India", "lat":28.6208,  "lon":77.3639},
    {"id":"jaipur_shastri","name":"Jaipur",    "country":"India", "lat":26.9388,  "lon":75.7997},
    {"id":"gurugram_sec51","name":"Gurugram",  "country":"India", "lat":28.4225,  "lon":77.0664},
    {"id":"pune_hadapsar", "name":"Pune",      "country":"India", "lat":18.5089,  "lon":73.9259},
    ...
    {"id":"toronto",      "name":"Toronto",   "country":"Canada", "lat":43.651070,"lon":-79.347015},
    {"id":"san_francisco","name":"San Francisco","country":"USA","lat":37.7749,  "lon":-122.4194},
...
class QCC:
    ...
    def simulate(self, weather: dict) -> dict:
        ...
        t  = transpile(qc, self.sim, optimization_level=1)
...
def batch():
    """Return all cities with weather + quantum data (parallel fetch)."""
    with concurrent.futures.ThreadPoolExecutor(max_workers=8) as ex:
        results = list(ex.map(lambda c: get_city_data(c["id"]), CITIES))
